...
namespace babyloan.API.Accounting.Provisioning.Api
{
    ...
    public class provisioningentriesController : ControllerBase
    {
        ...
        // POST: api/ProvisioningEntries
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT: api/ProvisioningEntries/5
        [HttpPut("{id}")]
